...
final class MeetingTimelineTests: XCTestCase {
    func testVersionTwoRecordProjectsChronologicalMultimodalContent() throws {
        let data = Data(
            (#"[{"schema_version":2,"meeting_id":"meeting-1","status":"completed","#
                + #""started_at":"2026-07-25T10:00:00Z","ended_at":"2026-07-25T11:00:00Z","events":[{"#
                + #""event_id":"event-1","meeting_id":"meeting-1","sequence":1,"#
                + #""occurred_at":"2026-07-25T10:01:00Z","kind":"transcript","#
                + #""provenance":{"source":"native_transcript"},"payload":{"type":"transcript","#
                + #""segment_id":"4E2CB506-925E-4A6E-BB68-E5006AB09BDF","text":"确认周五上线","#
                + #""speaker":"林晨","source":"microphone","translated_text":null}},{"event_id":"event-2","#
                + #""meeting_id":"meeting-1","sequence":2,"occurred_at":"2026-07-25T10:02:00Z","#
                ...
                + #""thread_id":"main","question":"谁负责回滚？"}},{"event_id":"event-5","#
                + #""meeting_id":"meeting-1","sequence":5,"occurred_at":"2026-07-25T10:05:00Z","#
                + #""kind":"assistant_answer","provenance":{"source":"meeting_agent","provider":"openai","#
                + #""model":"gpt-4o","request_id":"11111111-1111-1111-1111-111111111111"},"#
                + #""payload":{"type":"assistant_answer","request_id":"11111111-1111-1111-1111-111111111111","#
                + #""thread_id":"main","answer":"周岚 [M3]","sources":[{"source_id":"M3","#
                + #""event_id":"event-3","label":"截图分析"}],"degraded_vision":false,"#
                + #""status":"completed","error_message":null}}]}]"#).utf8
        )
